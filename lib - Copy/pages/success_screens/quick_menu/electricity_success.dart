...
class ElectricityResultPage extends StatefulWidget {
  const ElectricityResultPage({super.key});

  @override
  State<ElectricityResultPage> createState() => _ElectricityResultPageState();
}

class _ElectricityResultPageState extends State<ElectricityResultPage> {
  Color? _primaryColor;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Electricity Result"),
